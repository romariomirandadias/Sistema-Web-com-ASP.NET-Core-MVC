...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bob@hotmail.com", new DateTime(1997, 6, 22), 1600.00, d1);
            Seller s2 = new Seller(2, "Ana Bela", "anab@hotmail.com", new DateTime(1999, 4, 13), 1700.00, d3);
            Seller s3 = new Seller(3, "Richard Melow", "rich@gmail.com", new DateTime(1996, 8, 28), 1800.00, d2);
            Seller s4 = new Seller(4, "Juan Robin", "juanrob@hotmail.com", new DateTime(1994, 11, 14), 2300.00, d1);
            Seller s5 = new Seller(5, "Graça Alves", "graca@gmail.com", new DateTime(1993, 7, 15), 1900.00, d4);
            Seller s6 = new Seller(6, "Júnior Lima", "junior@hotmail.com", new DateTime(1997, 5, 13), 2500.00, d2);
